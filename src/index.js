...
function generatePoem(event) {
  ...
  let prompt = `Write a five-line love poem about ${messageElement.value}. write your poem and the title of the poem with the same language as ${messageElement.value}. Don't write "title" for headings. dont use ${messageElement.value} in the poem.`;
  let context =
